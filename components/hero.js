...
function hero() {
  return (
    <>
      <header className="md:bg-hero-pattern-lg bg-hero-pattern-xs bg-auto bg-no-repeat bg-center bg-cover bg-fixed" id="hero">
        <div className="bg-hero-blur flex flex-col items-center md:items-start px-4 justify-center h-screen">
